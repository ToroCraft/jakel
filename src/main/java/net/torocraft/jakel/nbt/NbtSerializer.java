...
public class NbtSerializer {
  ...
  private static List<Field> fields(Object o) {
    return Arrays.stream(o.getClass().getDeclaredFields()).filter(NbtSerializer::isAnnotated)
  ...
  private static Object fromCompound(Field f, Class type, NBTBase value) {
    ...
    switch (value.getClass().getName()) {
      ...
      case "net.minecraft.nbt.NBTTagDouble":
        return ((NBTTagDouble) value).getDouble();
  ...
  private static void throwError(Field f, Object o, Exception e) {
    System.out.println(
        "NBT serializer error Field[" + f.getName() + "] Object[" + o.getClass().getName() + "]");
    e.printStackTrace();
  }

  private static void logUnsupportedValue(Field f, Object value) {
    System.out.println(
        "Unsupported Type[" + f.getType().getName() + "] Field[" + f + "] Value[" + value + "]");
  }
