 ...
 *
 * Supports custom drawing inside (see drawPane method), clipping, scroll bar drawing, and background drawing.
 *
 * You can freely borrow this class, but keep the author annotation below and this comment.
 *
