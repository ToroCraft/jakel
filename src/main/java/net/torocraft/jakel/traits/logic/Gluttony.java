...
public class Gluttony {
  ...
  private static final Item[] TASTY_THINGS = {Items.BEEF, Items.CHICKEN, Items.MUTTON,
      Items.PORKCHOP, Items.RABBIT};
  ...
  private static List<EntityItem> getFoodWithinAABB(EntityLiving entity, int distance) {
    return entity.world
        .getEntitiesWithinAABB(EntityItem.class, TraitApi.nearByBox(entity.getPosition(), distance),
            Gluttony::isTasty);
  }
