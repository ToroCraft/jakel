...
import net.torocraft.jakel.traits.logic.Allergy;
import net.torocraft.jakel.traits.logic.Archer;
import net.torocraft.jakel.traits.logic.Chicken;
import net.torocraft.jakel.traits.logic.DoubleMelee;
import net.torocraft.jakel.traits.logic.Fireball;
import net.torocraft.jakel.traits.logic.Gluttony;
import net.torocraft.jakel.traits.logic.Greedy;
import net.torocraft.jakel.traits.logic.Heal;
import net.torocraft.jakel.traits.logic.Hydrophobia;
import net.torocraft.jakel.traits.logic.Inferno;
import net.torocraft.jakel.traits.logic.Potion;
import net.torocraft.jakel.traits.logic.Pyrophobia;
import net.torocraft.jakel.traits.logic.Reflection;
import net.torocraft.jakel.traits.logic.Summon;
import net.torocraft.jakel.traits.logic.Teleport;
