...
public class MessageHealAnimation implements IMessage {
  ...
  public static void init(int packetId) {
    Jakel.NETWORK
        .registerMessage(MessageHealAnimation.Handler.class, MessageHealAnimation.class, packetId,
            Side.CLIENT);
  }
  ...
  public static class Handler implements IMessageHandler<MessageHealAnimation, IMessage> {
    ...
    private static void spawnParticles(BlockPos pos, Random rand) {
      ...
      for (int i = 0; i < 15; i++) {
        ...
        Jakel.PROXY.spawnParticle(EnumParticleTypes.REDSTONE, x, y, z, 0.0D, 0.0D, 0.0D);
      }
      for (int i = 0; i < 10; i++) {
        ...
        Jakel.PROXY.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, x, y, z, 0.0D, 0.0D, 0.0D);
      }
    }
  }
}
