...
public class MessageWorshipAnimation implements IMessage {
  ...
  public static void init(int packetId) {
    Jakel.NETWORK
        .registerMessage(MessageWorshipAnimation.Handler.class, MessageWorshipAnimation.class,
  ...
  public static class Handler implements IMessageHandler<MessageWorshipAnimation, IMessage> {
    ...
    private static void spawnParticles(BlockPos pos, Random rand) {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        Jakel.PROXY.spawnParticle(EnumParticleTypes.HEART, x, y, z, 0.0D, 0.0D, 0.0D);
      }
    }
  }
