...
import net.torocraft.jakel.traits.TraitStore;
...
public class TraitApi {
  ...
  public static void applyTrait(EntityCreature entity, Trait trait) {
    entity.addTag(Jakel.TAG_HAS_TRAIT);
  ...
  public static void write(EntityCreature entity, TraitStore store) {
    ...
    entity.getEntityData().setTag(Jakel.NBT_TRAIT_STORE, c);
  }

  public static TraitStore read(EntityCreature entity) {
    NBTTagCompound c = entity.getEntityData().getCompoundTag(Jakel.NBT_TRAIT_STORE);
